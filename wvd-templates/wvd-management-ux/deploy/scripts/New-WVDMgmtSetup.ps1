...
try
{
                ...
                $clientAdApp = New-AzureADApplication -DisplayName $wvdSaaS_clientapp_display_name -PublicClient $true -AvailableToOtherTenants $false -Verbose -ErrorAction Stop
